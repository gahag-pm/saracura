...
public abstract class CalendarController extends JComponent {
    ...
    protected CalendarController(ArrayList<CalendarEvent> events) {
        this.events = events;
        setupTimer();
    ...
    private void drawDayHeadings() {
        ...
        for (int i = getStartDay().getValue(); i <= getEndDay().getValue(); i++) {
            ...
            String text = dayOfWeek.getDisplayName(TextStyle.SHORT, Locale.getDefault()) + " " + day.getDayOfMonth() + "/" + day.getMonthValue();
